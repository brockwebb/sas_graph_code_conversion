...
Research tasks are things that must happen but might not happen THIS session. They cross session boundaries. Without tracking, they fall through the cracks — this is the exact failure mode this project's workflow exists to prevent.
