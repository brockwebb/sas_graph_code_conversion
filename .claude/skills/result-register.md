...
- These files are grep-able, diff-able, and readable by both humans and future tooling.
- When the system matures, these YAML files become the migration source.
